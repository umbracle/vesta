...
type VestaServiceClient interface {
	...
	CatalogEntry(ctx context.Context, in *CatalogEntryRequest, opts ...grpc.CallOption) (*CatalogEntryResponse, error)
}
...
func (c *vestaServiceClient) CatalogEntry(ctx context.Context, in *CatalogEntryRequest, opts ...grpc.CallOption) (*CatalogEntryResponse, error) {
	out := new(CatalogEntryResponse)
	err := c.cc.Invoke(ctx, "/proto.VestaService/CatalogEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VestaServiceServer interface {
	...
	CatalogEntry(context.Context, *CatalogEntryRequest) (*CatalogEntryResponse, error)
...
func (UnimplementedVestaServiceServer) CatalogEntry(context.Context, *CatalogEntryRequest) (*CatalogEntryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CatalogEntry not implemented")
}
...
func _VestaService_CatalogEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CatalogEntryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VestaServiceServer).CatalogEntry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VestaService/CatalogEntry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VestaServiceServer).CatalogEntry(ctx, req.(*CatalogEntryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VestaService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CatalogEntry",
			Handler:    _VestaService_CatalogEntry_Handler,
		},
	},
